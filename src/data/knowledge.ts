    ...
    roleProfiles: [
      {
        ...
        scopeSummary: 'Handles standard support conversations with AI assistance.',
        aiSuggest: 'Allowed',
        humanSend: 'Allowed',
        manualReviewOverride: 'Cannot bypass sensitive-case review',
        knowledgeAccess: 'Published knowledge only',
        settingsAccess: 'Read only',
        auditAccess: 'Own case logs',
      },
      {
        role: 'Senior Agent',
        scopeSummary: 'Handles complex cases and triage before escalation.',
        aiSuggest: 'Allowed',
        humanSend: 'Allowed',
        manualReviewOverride: 'Can initiate review but not bypass it',
        knowledgeAccess: 'Knowledge and retrieval evidence',
        settingsAccess: 'Operational visibility',
        auditAccess: 'Team audit visibility',
      },
      {
        role: 'Team Lead',
        scopeSummary: 'Owns reviews, escalations, and policy supervision.',
        aiSuggest: 'Allowed',
        humanSend: 'Allowed',
        manualReviewOverride: 'Can make review decisions',
        knowledgeAccess: 'Full knowledge visibility',
        settingsAccess: 'Permissions and settings visibility',
        auditAccess: 'Full audit visibility',
      },
    ],
    memberAssignments: AGENTS.map(agent => ({
      memberName: agent.name,
      role: agent.role,
      inheritsFromRole: true,
      overrideSummary: 'No custom override',
      effectivePermissions: 'Inherited from role',
    })),
  },
  operationLogs: {
    entries: [
      {
        ...
        actor: 'System',
        action: 'RAG release promoted',
        scope: 'RAG Configuration',
        result: 'Recorded',
        detail: 'Stable retrieval configuration was promoted for complaint handling.',
      },
      {
        id: 'AUD-001',
        timestampLabel: '2026-05-22 11:39',
        sourceType: 'ai_audit',
        actor: 'System',
        action: 'Action blocked',
        scope: 'AI Audit / Ticket Flow',
        result: 'Refund execution was blocked pending supervisor approval.',
        detail: 'AI generated checklist only and did not execute refund.',
        riskLevel: 'High',
      },
    ],
  },

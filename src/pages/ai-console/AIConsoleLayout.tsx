...
export function AIConsole(props: AIConsoleProps) {
  return (
    <div className="min-w-0 space-y-4">
      ...
      {props.page === 'service-health' ? <ServiceHealthPage serviceHealth={props.serviceHealth} onRunServiceHealthCheck={props.onRunServiceHealthCheck} onRetryFailedJobs={props.onRetryFailedJobs} onRebuildVectorIndex={props.onRebuildVectorIndex} /> : null}
    </div>
  );
}
